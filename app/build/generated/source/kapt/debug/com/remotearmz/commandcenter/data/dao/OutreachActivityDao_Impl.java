...
public final class OutreachActivityDao_Impl implements OutreachActivityDao {
  ...
  public Flow<List<OutreachActivity>> getAllOutreachActivities() {
    final String _sql = "SELECT `outreach_activities`.`id` AS `id`, `outreach_activities`.`type` AS `type`, `outreach_activities`.`contactId` AS `contactId`, `outreach_activities`.`contactType` AS `contactType`, `outreach_activities`.`outcome` AS `outcome`, `outreach_activities`.`notes` AS `notes`, `outreach_activities`.`duration` AS `duration`, `outreach_activities`.`followUpRequired` AS `followUpRequired`, `outreach_activities`.`followUpDate` AS `followUpDate`, `outreach_activities`.`createdAt` AS `createdAt` FROM outreach_activities ORDER BY createdAt DESC";
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"outreach_activities"}, new Callable<List<OutreachActivity>>() {
      ...
      public List<OutreachActivity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfContactId = 2;
          final int _cursorIndexOfContactType = 3;
          final int _cursorIndexOfOutcome = 4;
          final int _cursorIndexOfNotes = 5;
          final int _cursorIndexOfDuration = 6;
          final int _cursorIndexOfFollowUpRequired = 7;
          final int _cursorIndexOfFollowUpDate = 8;
  ...
  public Flow<List<OutreachActivity>> getOutreachActivitiesRequiringFollowUp(
    ...
    final String _sql = "SELECT * FROM outreach_activities WHERE followUpRequired = 1 AND (followUpDate IS NULL OR followUpDate <= ?) ORDER BY CASE WHEN followUpDate IS NULL THEN 1 ELSE 0 END, followUpDate ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
  ...
  public Flow<List<OutreachActivity>> getFollowUpActivities() {
    final String _sql = "SELECT `outreach_activities`.`id` AS `id`, `outreach_activities`.`type` AS `type`, `outreach_activities`.`contactId` AS `contactId`, `outreach_activities`.`contactType` AS `contactType`, `outreach_activities`.`outcome` AS `outcome`, `outreach_activities`.`notes` AS `notes`, `outreach_activities`.`duration` AS `duration`, `outreach_activities`.`followUpRequired` AS `followUpRequired`, `outreach_activities`.`followUpDate` AS `followUpDate`, `outreach_activities`.`createdAt` AS `createdAt` FROM outreach_activities WHERE followUpRequired = 1 ORDER BY followUpDate ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"outreach_activities"}, new Callable<List<OutreachActivity>>() {
      @Override
      @NonNull
  ...
  @Override
  public Object getOutreachCountByOutcome(
      final Continuation<? super List<OutcomeCount>> continuation) {
    final String _sql = "SELECT outcome, COUNT(*) as count FROM outreach_activities GROUP BY outcome";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<List<OutcomeCount>>() {
      @Override
      @NonNull
      public List<OutcomeCount> call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
        try {
          final int _cursorIndexOfOutcome = 0;
          final int _cursorIndexOfCount = 1;
          final List<OutcomeCount> _result = new ArrayList<OutcomeCount>(_cursor.getCount());
          while (_cursor.moveToNext()) {
            final OutcomeCount _item;
            final OutreachOutcome _tmpOutcome;
            final String _tmp;
            if (_cursor.isNull(_cursorIndexOfOutcome)) {
              _tmp = null;
            ...
            _tmpOutcome = __converters.toOutreachOutcome(_tmp);
            final int _tmpCount;
            _tmpCount = _cursor.getInt(_cursorIndexOfCount);
            _item = new OutcomeCount(_tmpOutcome,_tmpCount);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getOutreachCountByType(final Continuation<? super List<TypeCount>> continuation) {
    final String _sql = "SELECT type, COUNT(*) as count FROM outreach_activities GROUP BY type";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<List<TypeCount>>() {
      @Override
      @NonNull
      public List<TypeCount> call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
        try {
          final int _cursorIndexOfType = 0;
          final int _cursorIndexOfCount = 1;
          final List<TypeCount> _result = new ArrayList<TypeCount>(_cursor.getCount());
          while (_cursor.moveToNext()) {
            final TypeCount _item;
            final OutreachType _tmpType;
            final String _tmp;
            if (_cursor.isNull(_cursorIndexOfType)) {
              _tmp = null;
            ...
            final int _tmpCount;
            _tmpCount = _cursor.getInt(_cursorIndexOfCount);
            _item = new TypeCount(_tmpType,_tmpCount);
            _result.add(_item);
          }
          return _result;
        } finally {
